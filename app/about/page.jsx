...
//               <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-500 rounded-xl md:rounded-2xl flex items-center justify-center shrink-0 shadow-xl shadow-blue-500/30">
//                 <i className="ri-user-line text-2xl md:text-3xl text-white"></i>
//               </div>
//               <div>
//                 <h2 className="text-xl md:text-4xl font-bold bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-1 md:mb-2">
//                   About Me
//                 </h2>
...
//             <div className="prose prose-lg max-w-none">
//               <p className="text-slate-700 leading-relaxed text-justify whitespace-pre-line text-base md:text-lg font-normal">
//                 {data.bio}
//               </p>
//             </div>
//           </div>
...
//               <div className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/30">
//                 <i className="ri-graduation-cap-line text-xl md:text-2xl text-white"></i>
//               </div>
//               <h2 className="text-xl md:text-4xl font-bold bg-gradient-to-r from-slate-900 to-blue-900 bg-clip-text text-transparent">
//                 Education
//               </h2>
//             </div>
...
//                 <div
//                   key={index}
//                   className="bg-white/80 backdrop-blur-sm p-5 md:p-8 rounded-xl md:rounded-2xl border border-slate-200/50 hover:shadow-2xl hover:border-blue-300/50 transition-all duration-300 hover:-translate-y-1"
//                   style={{ backgroundColor: "rgba(255, 255, 255, 0.8)" }}
//                 >
//                   <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-5">
//                     <div className="flex-1 min-w-0">
//                       <h3 className="text-base md:text-2xl font-bold text-slate-900 mb-2 md:mb-3 flex items-center gap-2 md:gap-3">
//                         <span className="w-2 h-2 md:w-2.5 md:h-2.5 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full shadow-lg shadow-blue-400/50"></span>
//                         {edu.degree}
//                       </h3>
//                       <p className="text-slate-700 font-semibold text-sm md:text-lg mb-2 md:mb-3 ml-4 md:ml-5">
//                         {edu.institution}
//                       </p>
//                       {edu.description && (
//                         <p className="text-slate-600 ml-4 md:ml-5 text-sm md:text-base leading-relaxed">
//                           {edu.description}
//                         </p>
//                       )}
//                     </div>
//                     {edu.year && (
//                       <span className="inline-flex items-center gap-2 px-4 md:px-5 py-2 md:py-2.5 rounded-lg md:rounded-xl text-xs md:text-sm font-bold bg-gradient-to-r from-blue-50 to-cyan-50 text-blue-700 border-2 border-blue-200 whitespace-nowrap shrink-0 shadow-sm self-start md:self-auto">
...
//           <section className="mb-8 md:mb-12">
//             <div className="flex items-center gap-3 md:gap-4 mb-6 md:mb-8">
//               <div className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-emerald-600 to-teal-500 rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-500/30">
//                 <i className="ri-briefcase-line text-xl md:text-2xl text-white"></i>
//               </div>
//               <h2 className="text-xl md:text-4xl font-bold bg-gradient-to-r from-slate-900 to-emerald-900 bg-clip-text text-transparent">
//                 Experience
//               </h2>
//             </div>
...
//                 <div
//                   key={index}
//                   className="bg-white/80 backdrop-blur-sm p-5 md:p-8 rounded-xl md:rounded-2xl border border-slate-200/50 hover:shadow-2xl hover:border-emerald-300/50 transition-all duration-300 hover:-translate-y-1"
//                   style={{ backgroundColor: "rgba(255, 255, 255, 0.8)" }}
//                 >
//                   <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-5">
//                     <div className="flex-1 min-w-0">
//                       <h3 className="text-base md:text-2xl font-bold text-slate-900 mb-2 md:mb-3 flex items-center gap-2 md:gap-3">
//                         <span className="w-2 h-2 md:w-2.5 md:h-2.5 bg-gradient-to-r from-emerald-600 to-teal-500 rounded-full shadow-lg shadow-emerald-400/50"></span>
//                         {exp.position}
//                       </h3>
//                       <p className="text-slate-700 font-semibold text-sm md:text-lg mb-2 md:mb-3 ml-4 md:ml-5">
//                         {exp.institution}
...
//                     </div>
//                     {exp.duration && (
//                       <span className="inline-flex items-center gap-2 px-4 md:px-5 py-2 md:py-2.5 rounded-lg md:rounded-xl text-xs md:text-sm font-bold bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 border-2 border-emerald-200 whitespace-nowrap shrink-0 shadow-sm self-start md:self-auto">
...
//             <div className="flex items-center gap-3 md:gap-4 mb-6 md:mb-8">
//               <div className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-amber-600 to-orange-500 rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg shadow-amber-500/30">
//                 <i className="ri-trophy-line text-xl md:text-2xl text-white"></i>
//               </div>
//               <h2 className="text-xl md:text-4xl font-bold bg-gradient-to-r from-slate-900 to-amber-900 bg-clip-text text-transparent">
//                 Awards & Honors
//               </h2>
//             </div>
...
//                 <div
//                   key={index}
//                   className="bg-white/80 backdrop-blur-sm p-5 md:p-7 rounded-xl md:rounded-2xl border border-slate-200/50 hover:shadow-2xl hover:border-amber-300/50 transition-all duration-300 hover:-translate-y-1"
//                   style={{ backgroundColor: "rgba(255, 255, 255, 0.8)" }}
//                 >
//                   <div className="flex items-start gap-4 md:gap-5">
//                     <div className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-amber-100 to-orange-100 rounded-lg md:rounded-xl flex items-center justify-center shrink-0 border border-amber-200/50">
//                       <i className="ri-medal-line text-xl md:text-2xl text-amber-600"></i>
//                     </div>
//                     <div className="flex-1">
//                       <h3 className="text-base md:text-xl font-bold text-slate-900 mb-1 md:mb-2">
//                         {award.title}
//                       </h3>
//                       <p className="text-xs md:text-base text-slate-700 font-medium mb-2 md:mb-3">
//                         {award.organization}
//                       </p>
//                       {award.year && (
//                         <span className="inline-flex items-center gap-2 text-xs md:text-sm font-bold text-amber-700 bg-amber-50 px-3 md:px-4 py-1.5 md:py-2 rounded-lg md:rounded-xl border-2 border-amber-200 shadow-sm">
//                           <i className="ri-calendar-line"></i>
//                           {award.year}
//                         </span>
//                       )}
//                       {award.description && (
//                         <p className="text-xs md:text-sm text-slate-600 mt-3 md:mt-4 leading-relaxed">
//                           {award.description}
//                         </p>
//                       )}
//                     </div>
