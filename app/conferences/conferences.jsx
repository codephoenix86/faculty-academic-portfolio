      ...
      <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row gap-3 sm:gap-4 px-4 sm:px-0">
        ...
        <div className="relative sm:w-auto">
          ...
          <select
            ...
            className="appearance-none w-full sm:w-auto pl-10 sm:pl-12 pr-10 sm:pr-12 py-2.5 sm:py-3.5 bg-white border border-gray-200 rounded-xl text-sm sm:text-base text-gray-900 font-medium focus:outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-100 transition-all duration-300 cursor-pointer shadow-sm hover:shadow-md"
          >
...
function ConferenceCard({ conference }) {
  ...
  return (
    <motion.div
      ...
      variants={fadeInUp}
    >
      <div className="group bg-white border border-gray-200 rounded-xl p-5 sm:p-7 transition-all duration-300 hover:shadow-xl hover:border-purple-300 hover:-translate-y-1">
        <div>
          {/* Header */}
          ...
          {/* Title */}
          <h4 className="text-base sm:text-xl md:text-2xl font-semibold mb-3 sm:mb-4 text-gray-900 group-hover:text-purple-700 transition-colors duration-300 leading-tight tracking-tight">
            {title}
          </h4>
